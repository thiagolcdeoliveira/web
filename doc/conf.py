...
project = u'Rango'
copyright = u'2017, Thiago L C de Oliveira'
author = u'Thiago L C de Oliveira'
...
latex_documents = [
    (master_doc, 'rango.tex', u'rango Documentation',
     u'Thiago L C de Oliveira', 'manual'),
]
...
man_pages = [
    (master_doc, 'rango', u'rango Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rango', u'rango Documentation',
     author, 'rango', 'One line description of project.',
     'Miscellaneous'),
]
